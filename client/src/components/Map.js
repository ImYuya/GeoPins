...
const Map = ({ classes }) => {
  ...
  const [userPosition, setUserPotition] = useState(null);
  useEffect(() => {
    getUserPosition();
  }, []);
  ...
  const getUserPosition = () => {
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(position => {
        ...
        setUserPotition({ latitude, longitude });
      });
    }
  };
  ...
  return (
    <div className={mobileSize ? classes.rootMobile : classes.root}>
      ...
      >
        ...
        {/*  Pin for User's Current Postion */}
        {userPosition && (
          <Marker
        ...
        {/* Popup Dialog fore created Pins */}
        {popup && (
          <Popup
            anchor="top"
      ...
      <Subscription
        ...
        onSubscriptionData={({ subscriptionData }) => {
          ...
          dispatch({ type: "DELTE_PIN", payload: pinDeleted });
        }}
      />
